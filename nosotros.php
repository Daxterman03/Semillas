...
<body>
    ...
    <div class="infoprograma">
        <p>
            Con la organización de la Coordinación de Emprendedurismo y Economía Social, dependiente de la Secretaría de Desarrollo Productivo y Planeamiento Urbano, el Gobierno de Venado Tuerto inscribe para la entrega de semillas de la temporada primavera-verano 2021, en el marco del programa Cultivar, una iniciativa del municipio que estimula la producción huertera.  Se trata de semillas adquiridas con recursos propios a la cooperativa de productores Fecoagro de San Juan. El kit que se entregará sin cargo a partir de septiembre comprende ocho especies: acelga, albahaca, cebolla, lechuga, remolacha, tomate, zanahoria y zapallo.
        </p>
    </div>
    <div class="infoprograma2">
        <p>
            “Desde el programa Cultivar se dio como finalizado en el mes de abril la entrega de semillas OTOÑO-INVIERNO correspondiente al año 2021. A partir de este momento se estan tomando nuevas inscripciones al programa que hoy ya supera los dos mil inscriptos. Ya en el mes de septiembre se estarán entregando las semillas del programa correspondientes a la temporada PRIMAVERA-VERANO 2021” 
        </p>
    </div>
    ...
    <div class="contenedor">
           ...
           <h1>Experiencias de la gente</h1>
            ...
            <h1>Videos</h1>
                    ...
                    <video src="css/video2.mp4" controls ></video>
            </div>
    </div>
