...
<body>
    ...
    <main class="main">
        <div class="descripcion">
            <h1>Nosotros</h1>
            <p>
                El programa Cultivar acerca a la población una oportunidad al recurso y también a un espacio donde se puedan potenciar habilidades, construir vínculos y generar un sustento familiar a través de las huertas.
